...
//
// Última sincronización: 2026-06-11T12:42:48.750Z
//
...
export const verificacionesAuditoria: VerificacionAuditoria[] = [
  {
    ...
    "estadoHttp": 200,
    "fechaVerificacion": "2026-06-11T12:42:39.116Z",
    "resultado": "ok",
    "hallazgos": [
  ...
  },
  {
    ...
    "estadoHttp": 200,
    "fechaVerificacion": "2026-06-11T12:42:45.735Z",
    ...
    "hallazgos": [
      ...
      "Más reciente entre plataformas: abril de 2025 (drupal-legacy). Distancia al mes en curso: 14 meses."
    ],
    "meta": {
      "plataformas": [
        {
  ...
  },
  {
    ...
    "estadoHttp": 200,
    "fechaVerificacion": "2026-06-11T12:42:48.750Z",
    "resultado": "ok",
    "hallazgos": [
      ...
      "El cronograma cubre el mes en curso o un mes futuro."
    ],
    "meta": {
      "mesActual": {
        "anio": 2026,
...
export const verificacionesAuditoriaMeta = {
  sincronizadoEl: "2026-06-11T12:42:48.750Z",
  total: 3,
  resultadosPorTipo: {
    ok: 2,
    desactualizado: 1,
