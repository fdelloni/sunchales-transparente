/**
 * Registro de fuentes verificables para todo dato mostrado en la app.
 * Cada item de datos referencia uno de estos sources via `sourceId`.
 */
export type Source = {
  id: string;
  title: string;
...
export const sources: Record<string, Source> = {
  ...
  fondoLey12385: {
    ...
    url: "https://movilquique.com/politica/%F0%9F%92%B0-sunchales-recibira-613-millones-de-recursos-provinciales-para-obras-y-equipamiento-en-2026/",
    fetchedAt: "2026-04-29",
  ...
  organigramaMunicipal: {
    ...
    title: "Organigrama Municipal Sunchales — gestión Pinotti",
    url: "https://meridianodigital.com.ar/nombre-por-nombre-el-nuevo-organigrama-municipal-completo/",
    fetchedAt: "2026-04-29",
    notes: "Estructura de Secretarías y Subsecretarías con sus titulares."
  },
  ley27275: {
    id: "ley27275",
